...
$query=mysqli_query($con,"insert into tblcomplaints(userId,category,Office,complaintType,Department,complaintDetails,complaintFile) values('$uid','$category','$office','$complaintype','$department','$complaintdetials','$compfile')");
...
<?php $sql=mysqli_query($con,"select id,Office from office ");
while ($rw=mysqli_fetch_array($sql)) {
  ?>
  <option value="<?php echo htmlentities($rw['id']);?>"><?php echo htmlentities($rw['Office']);?></option>
<?php
}
?>
</select>
