...
<html lang="en">
  <head>
    ...
    <title>DMS | Document Details</title>
...
<?php include('includes/sidebar.php');?>
      <section id="main-content" style="padding-left:5%; color:#000">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> Document Details</h3>
            <hr />
...
{?>
          	<div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Document Number : </b></label>
          		<div class="col-sm-4">
...
<label class="col-sm-2 col-sm-2 control-label"><b>Office:</b> </label>
              <div class="col-sm-4">
              <p><?php echo htmlentities($row['Office']);?></p>
              </div>
            </div>
  ...
  <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Document Type :</b></label>
              <div class="col-sm-4">
...
<?php } ?>
 ...
 <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Document Details </label>
              <div class="col-sm-10">
